...
if(isset($_POST['username'])){
  // LOGIN ADMINISTRADOR
    ...
    $MM_redirectLoginSuccess = "../system/administrador/index.php";
    ...
    $password = $_POST['password'];
      ...
      $LoginRS__query=sprintf("SELECT * FROM usuarios WHERE username=%s AND password=%s",
      GetSQLValueString($loginUsername, "text"), 
      GetSQLValueString($password, "text")); 
       
      $LoginRS = mysql_query($LoginRS__query, $cepco) or die(mysql_error());
